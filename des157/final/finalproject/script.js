(function() {
    ...
    let text = ["beautiful.", "powerful.", "strong.","radiant.", "confident.", "glowy."];
    let counter = 0;
    ...
    window.addEventListener('scroll', function (){
        ...
        switch(true) {
            case page < 3100: body.className="light"; break;  //bg color is beige
            case page < 6300: body.className="dark"; break; //bg color is dark navy
            case page < 6400: body.className="green"; break; //bg color is sage green
    ...
    image2.src =  "images/vitaminc.png";
    ...
    var btnstart = document.getElementById('starttype');
    ...
    btnstart.addEventListener("click", function (){
        ...
        document.getElementById("starttype").removeAttribute('id');
    });
    ...
    var btnstart2 = document.getElementById('starttype2');

    //button disappears once clicked
    btnstart2.addEventListener("click", function (){
        typeWriter2();
        starttype2.innerHTML = '';

        document.getElementById("starttype2").removeAttribute('id');
    });
