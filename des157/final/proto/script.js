(function() {
   ...
   /*  //typewriter
    var i = 0;
    var txt = 'Lorem ipsum dummy text blablaum dummy text blablaum dummy text blablaum dummy text blablaum dummy text blablaum dummy text blablaum dummy text blablaum dummy text blabla.';
    var speed = 50;
